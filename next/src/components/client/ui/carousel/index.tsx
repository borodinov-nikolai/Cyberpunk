...
const Carousel = () => {
  ...
  return (
    <div  >
      ...
      <div className={'hidden w-[32%] absolute z-10 right-[17%] bottom-0 sm:block lg:hidden'} ></div>
      {/* <div className={' w-[32%] absolute z-10 right-[17%] bottom-0 sm:hidden'} ></div> */}
